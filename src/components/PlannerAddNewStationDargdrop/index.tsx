...
const PlannerAddNewStationDargdrop: React.FC<PlannerAddNewStationDargdropProps> = (props) => {
	return (
		<>
			<div className={props.className}>
				...
				>
					<div className="flex flex-col items-center justify-center w-auto">
						<Text className="text-center text-gray-700 text-sm tracking-[0.46px] w-auto" size="txtLatoRegular14">
							{props?.dragtext}
						</Text>
					</div>
				</div>
